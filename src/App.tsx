...
const Virtual = lazy(
  () => import("./pages/VirtualAssistant/VirtualAssitantHomepage"),
);
const Recommend = lazy(() => import("./components/AI-Assistant/Recommend"));
const Recommended = lazy(
  () => import("./pages/VirtualAssistant/ShowVirtualAssistantRecommendations"),
);
const SmartAssistant = lazy(
  () => import("./pages/VirtualAssistant/VirtualAssistantWelcomeBackPage"),
);
...
const Step3Party = lazy(
  () => import("./pages/VirtualAssistant/ChoosePopulation"),
);
const Step4FoodType = lazy(
  () => import("./pages/VirtualAssistant/ChooseFoodType"),
);
      ...
      <OrderProvider>
        <div className="w-full min-h-dvh" style={{ backgroundImage }}>
          ...
          {showSidebar && (
            <>
              <Sidebar />
              {/* Mobile overlay behind sidebar to capture taps/scrolls */}
              {sidebarOpen && (
                <div
