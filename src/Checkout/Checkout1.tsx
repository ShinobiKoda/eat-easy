    ...
    <div className="w-full min-h-screen">
      ...
      >
        ...
        <div className="pt-25 md:pt-30 max-w-[1440px] mx-auto flex flex-col items-center py-6 px-4 md:px-6 space-y-6 md:space-y-10">
          <div className="flex flex-col lg:flex-row bg-red-500 gap-6 lg:gap-8 w-full items-center lg:items-start">
            
            {/* Payment Method Column */}
            <div className="bg-[#FFFFFF] dark:bg-(--neutral-700) text-center shadow-[0_4px_12px_rgba(0,0,0,0.10)] rounded-2xl p-8 md:p-12 w-full lg:w-[60%] flex flex-col items-center justify-center h-full">
              <motion.div 
            ...
            <div className="flex flex-col gap-6 w-full lg:w-[40%]">
              ...
              {/* Total Price Card */}
              <div className="bg-[#FFFFFF] dark:bg-(--neutral-700) rounded-2xl p-6 lg:p-8 shadow-[0_4px_12px_rgba(0,0,0,0.10)] flex justify-between items-center">
          ...
          {/* Action Bar */}
          <div className="w-full flex flex-col sm:flex-row justify-between items-center rounded-[32px] px-8 py-6 bg-[#FFFFFF] dark:bg-(--neutral-700) shadow-[0_4px_12px_rgba(0,0,0,0.10)] gap-6 mt-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-[320px] py-5 rounded-2xl bg-(--purple-4) dark:bg-(--purple-4) text-white font-medium text-[20px] flex justify-center items-center gap-3 cursor-not-allowed shadow-inner"
            >
