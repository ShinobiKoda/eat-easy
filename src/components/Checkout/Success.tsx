      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 bg-black/60 z-100 backdrop-blur-md min-h-screen"
          />
          ...
          >
            <div className="bg-[#2a2a4a] dark:bg-[#2a2a4a] rounded-3xl shadow-2xl w-full max-w-[400px] p-10 relative pointer-events-auto">
              {/* Close button */}
              <button
                type="button"
                onClick={onClose}
              ...
              >
                <LiaTimesSolid size={22} className="text-gray-400 hover:text-white" />
              </button>
