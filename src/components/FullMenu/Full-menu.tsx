        ...
        <div className="pt-18 md:pt-24 max-w-[1440px] mx-auto">
          ...
          <div className="px-6 py-4 md:py-8 md:px-10.5 flex flex-col gap-6">
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                <div className="items-center gap-[30px] grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                ...
                <motion.div
                  ...
                  className="items-center gap-[30px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
