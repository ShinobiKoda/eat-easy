  ...
  return (
    <div className="w-full min-h-screen">
      <div>
        ...
        <div className='pt-18 md:py-30 lg:py-50 max-w-[1440px] mx-auto flex flex-col items-center py-6 px-6 sm:px-20 lg:px-6 space-y-10'>

          <div className='flex flex-col items-center text-center max-w-xl mb-20 md:mb-10'>
            <h1 className='text-[22px] lg:text-[40px] text-(--neutral-800) dark:text-[#FFFFFF] font-medium mb-2'>It seems like we already know <br/> each other 🤝</h1>
          ...
          <div className='space-y-4 w-full lg:w-xl flex flex-col items-center mb-50 md:mb-20'>
