      ...
      <div>
        ...
        <div className='pt-20 md:py-30 lg:pt-50 lg:pb-20 max-w-[1440px] mx-auto flex flex-col items-center py-6 px-6 sm:px-20 lg:px-6'>
          ...
          <div className='flex flex-col items-center text-center max-w-xl mb-20 md:mb-10'>
            ...
            <p className='text-[16px] lg:text-[16px] font-medium text-(--neutral-800) dark:text-(--neutral-150) max-w-[520px]'>You can use the recommendations configured during your last visit to our restaurant or you can have new ones.</p>
          </div>

          <div className='gap-6 flex flex-col items-center mb-50 md:mb-20 w-full sm:w-[480px]'>

            <div className='bg-white dark:bg-(--neutral-700) rounded-2xl w-full mx-auto p-7 shadow-[0_4px_12px_rgba(0,0,0,0.10)] flex justify-between items-center'>
              <p className='text-[14px] lg:text-[18px] text-(--neutral-900) dark:text-white font-semibold'>New recommendation</p>
            ...
            <div className='bg-white dark:bg-(--neutral-700) rounded-2xl w-full mx-auto p-7 shadow-[0_4px_12px_rgba(0,0,0,0.10)] flex justify-between items-center'>
              <div className='space-y-3'>
                <p className='text-[14px] lg:text-[18px] text-(--neutral-900) dark:text-white font-semibold'>Your last recommendation</p>
                <div className='flex gap-2 items-center text-(--neutral-500) dark:text-(--neutral-300)'>
                  <span>
                    <SlCalender className='w-7 text-(--yellow-1) text-white' />
                  </span>
                  07/02/2026
                </div>
              </div>
