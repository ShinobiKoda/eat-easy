    ...
    <div className="w-full min-h-screen">
      ...
      <div>
        ...
        <div className="pt-20 md:py-30 lg:pt-30 lg:pb-20 max-w-[1440px] mx-auto flex flex-col items-center p-6 space-y-10 mb-5">
          ...
          <div className="text-[16px] lg:text-[20px] font-600 w-full lg:w-xl flex flex-col items-center gap-4">
            <NavLink to="/welcome" className="w-full max-w-[480px]">
              <motion.button
                whileTap={{ scale: 0.95 }}
            ...
            <NavLink to="/recommend" className="w-full max-w-[480px]">
              <motion.button
                whileTap={{ scale: 0.95 }}
